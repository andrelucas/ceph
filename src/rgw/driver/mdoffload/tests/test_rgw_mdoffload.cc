...
//     filter->get_bucket(this, filter_user.get(), b, &bucket, y);
...
//         .WillOnce(
//             Return(ByMove([&]() {
//               std::unique_ptr<NiceMock<akamai::mock::MockUser>> mock_user(new NiceMock<akamai::mock::MockUser>());
//               EXPECT_CALL(*mock_user, get_display_name())
//                   .WillRepeatedly(ReturnRef(u.id));
//               EXPECT_CALL(*mock_user, get_tenant())
//                   .WillRepeatedly(ReturnRef(u.tenant));
//               EXPECT_CALL(*mock_user, get_ns())
//                   .WillRepeatedly(ReturnRef(u.ns));
//               return mock_user;
//             }())));
...
// TEST_F(RGWMDOffloadFilterDriverMockFixture, WithMockGetUser)
// {
//   ASSERT_NE(filter, nullptr);
